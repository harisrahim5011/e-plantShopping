...
//   const [totalItems, setTotalItems] = useState(0);
  ...
  const handleAddToCart = (product) => {
    ...
    // }));
    // setTotalItems((prev) => prev + 1); // Increment the total items count
  };
  const plantsArray = [
    {
            ...
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <h1 className="cart">
                ...
                >
                  ...
                  ></path>
                  <text textAnchor="middle" x="140" y="150" fill="white">
                    {totalItems}
                  </text>
                </svg>
              </h1>
                ...
                {category.plants.map((plant, plantIndex) => (
                  <div className="product-card" key={plantIndex}>
                    ...
                    <button
                      ...
                      style={{backgroundColor:alreadyInCart(plant.name)?"gray":""}}
                    >
                      {alreadyInCart(plant.name)? "Added" : "Add to Cart"}
                    </button>
                  </div>
                ))}
              </div>
